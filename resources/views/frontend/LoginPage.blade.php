...
<body>
    <div class="headg">
        <h1 style="font-size: 40px; font-weight: 900; color:rgb(196, 178, 178);">Tripathi <br>Electronics</h1>
        <h2 style="font-size:20px; color:rgb(141, 179, 45);"><span>“Online learning is not the next big
                thing,<br>&nbsp; it is the now big thing”</span></h2>
    </div>
    <div class="main">
