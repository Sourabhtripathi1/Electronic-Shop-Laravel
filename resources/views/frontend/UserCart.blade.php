        ...
        <div class="cart-table">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><img src="{{ env('APP_URL') }}/storage/site-assets/{{ getVariantImage($cart_item['Variant_id'], $variants, $pictures) }}" alt="" height="40px" width="80px"></td>
                        <td> {{ getProductNameFromVariant($cart_item['Variant_id'], $variants, $products) }} x
            ...
            <div class="btn-checkout-container">
                <a href=""><button class="btn-checkout btn-lg">Checkout</button></a>
            </div>
            @else
