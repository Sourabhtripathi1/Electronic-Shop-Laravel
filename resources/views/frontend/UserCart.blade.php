            ...
            <div class="cart-table">
                @if (count($cart) > 0)
                        ...
                        <tbody>
                            @foreach ($cart as $cart_item)
                                <tr>
                                    <td class="cart_image">
                                        <img
                                            src="{{ env('APP_URL') }}/storage/site-assets/{{ getVariantImage($cart_item['Variant_id'], $variants, $pictures) }}">
                                    </td>
                    ...
                    <div class="btn-checkout-container">
                        <a href="{{ env('APP_URL') }}/user/checkout"><button
                                class="btn-checkout btn-lg">Checkout</button></a>
                    </div>
                @else
