        ...
        <div class="container">
            <div>
                <div class="profile-record row">
                    ...
                    <input type="text" class="form-control col-md-4" name="name" id="profile_name" value="{{ $user['Name'] }}">
                </div>
                <div class="profile-record row">
                    <h3 class="col-md-4">Username</h3>
                    <input type="text" class="form-control col-md-4" name="name" id="profile-uname" value="{{ $user['Username'] }}">
                </div>
                <div class="profile-record row">
                    <h3 class="col-md-4">Email</h3>
                    <input type="text" class="form-control col-md-4" name="name" id="profile-email" value="{{ $user['Email'] }}">
                </div>
