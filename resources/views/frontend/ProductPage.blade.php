            ...
            <div class="col-md-5">
                <div class="product-details">
                    ...
                    <ul class="product-btns">
                        <li><a href="{{ env('APP_URL') }}/products/wishlist/add/{{ $id }}/{{ getFirstVariant($id, $products, $variants) }}" id="add_wishlist_button"><i class="fa fa-heart-o"></i> add to wishlist</a></li>
